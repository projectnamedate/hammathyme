...
export const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    pieces: [
      ...
      {
        slug: "openusd-twin-scene",
        title: "openusd twin scene",
        year: "2026",
        blurb: "an openusd scene of a facility or asset, composed and layered so live data can drive it in any usd-compliant tool.",
        status: "coming-soon",
        tint: "var(--bloodlust)",
      },
    ],
