  ...
  },
  {
    ...
    pieces: [
      ...
      },
      {
        ...
        year: "2026",
        blurb: "public architecture for the prompt stacks behind Hammer work: briefs, prompt packs, model recipes, review gates, and handoff rules.",
        status: "live",
        tint: "var(--cream-2)",
      },
      {
        ...
        year: "2026",
        blurb: "the reusable operating layer for AI production: color, character prompting, video recipes, shader direction, and review workflows.",
        status: "live",
        tint: "var(--cream-1)",
      },
    ],
