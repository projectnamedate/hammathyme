...
mouth, pointing hand, presenting hand, waving hand, small shot-board prop,
separated parts clearly visible for rigging, flat colors, clean shape language,
no text, no logo, no complex background, no black side-part hair, no moustache,
no uniform silhouette, no central shadow under the nose
...
mouth_closed, mouth_small, mouth_open, mouth_smile, frame_prop, dot,
state_label.
...
accents subtle so the cartoon performer remains the hero.
